...
**Bundle pricing:** a bundle = **sum of its component regular prices, then 10% off**. Indicate the contents, the list total, the bundle price, and the savings. (e.g., Connetix Full = Mid + Roads&Ramps $89 + Mega $209 → $592 list → **$533** (10% off). Starter $154→$139, Mid $294→$265.)
