...
CANON = {
    ...
    "Spinning Tops","Kaleidoscopes","Keepsakes","Shops & Market Play",
...
TITLE_RULES = [
    ...
    ("STEM Toys", ["lucent","light table","light panel","gears set","circuit","microscope","magnifier","translucent cube"]),
    ...
    ("Cars, Trucks & Trains", [" car ","truck","train","vehicle","digger","excavator"," plane","airplane"," boat"," tractor","camper","bulldozer","fire engine","locomotive","racer"]),
    ("Play Food", ["play food","felt food","wooden food","grocer","ice cream"," pie","cupcake","cookie","donut","doughnut","pizza","sushi","waffle","pancake","muffin","croissant","macaron","pretzel","bagel","sandwich","popsicle"," cake","fruit","vegetable","veggie","egg carton","tea biscuit"]),
    ("Shops & Market Play", ["cash register","market stand","market stall","shopping cart","play money","grocery store","checkout","farm stand","fruit stand","ice cream cart","lemonade stand"]),
    ...
    ("Small World Play", ["playmat","play mat","playscape","play scape"]),
