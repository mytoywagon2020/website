...
**How it began.** Irfana and Rashid could not find the handmade wooden and felt toys they wanted for their own daughters, so they wrote letters to makers directly and stocked only what came back. They **founded the shop in December 2020, during Covid,** and opened it in **January 2021**. (Dates reconciled: Dec 2020 founding = the catalog's *"since 2020"*; Jan 2021 = the Our Story page. Both are correct.) Irfana is a New Yorker, raised in Queens, who moved west to California and fell in love with it.

**The name, the logo & the feeling (the north star).** The wagon is playful but literal: it carries the very toys the shop sells. The logo draws on the old wooden wagons of pioneers heading west, a journey the founder made herself (Queens to California). The name comes from the family's Covid ritual: near-daily trips to the local arboretum, the two girls riding in their wagon, and, staying late while distanced, the parents and children taking turns pushing one another in it. Pure joy. **That feeling is the brand's emotional north star: the toys should bring unbridled joy to the families who buy them.**

**How to use the joy (without breaking the voice rules):** evoke it, never announce it. Show the scene that produces joy (a child absorbed for forty quiet minutes; the wagon ride at dusk; the classroom that settles), and let the reader feel it. Do not write "joy!", stack exclamation marks, or lean on "magical / whimsical" as filler. Joy, earned through concrete detail, is the payoff of the show-don't-tell rule.
