...
- **Nature Play (§2) DONE 11/20:** imaged from twins — Forest Floor Tinker Tray (had), Woodland Leaves/Forest Mushrooms Basket/Bird Eggs (Moon Picnic), Turkey Pair (Bumbu), Tongs/Teak Spoon Set/Slotted Spoon/Nesting Bowls/Coconut Sieve (Papoose), Busy Bee Tray (Gus&Mabel). **OPEN/needs owner twin confirm (9):** felt loose-parts Acorns/Autumn Leaves/Pinecones/Pumpkins/Forest Mushrooms (Papoose felt versions — store search returns acorn-baby dolls & food sets, not clean loose-parts twins; owner identify), Bumbu Pumpkin Harvest (bundle), + 3 bundles Autumn Set/Nature Tools Set/Everything Play Bundle.
- STILL TO BACKFILL: Fairy gnomes/village (4) + Kaleidoscope, Creative Arts (~14), Dramatic Play bundles (PWF/TLS/FYS/SH), STEAM Magnifier/Bean. Specs (descriptions) still generic on many — owner rule wants real specs too; revisit.
