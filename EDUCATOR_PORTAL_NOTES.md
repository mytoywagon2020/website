...
- **Small World (§4) DONE 21/22:** hero images from twins — play mats (Forest Caves=Papoose, Fairy Streamlet/Coralwhim=Gus&Mabel, Garden of Moon/Hobbit Hollow=Himalayan Felt, Featherfloat=Papoose pond) + puppet sets (Tara finger-puppet twins: Insect/Bugs, Ocean, Polar, Butterflies, Aus Birds, Old MacDonald, Speckled Frogs, Itsy Bitsy, Monkeys, Ducks, Gruffalo's Child) + 3 bundles + Tiny Tale Terrains (placeholder hero=fairy streamlet, replace later). Wispy Waters Way DONE (twin Gus&Mabel "Wispy Waters Way Felt Playmat" 8390714654890). §4 now 22/22 imaged. Only note: Tiny Tale Terrains used a placeholder hero (fairy streamlet) — owner may want a better one.
- STILL TO BACKFILL: Nature Play (most), Fairy gnomes/village (4) + Kaleidoscope, Creative Arts (~14), Dramatic Play bundles (PWF/TLS/FYS/SH), STEAM Magnifier/Bean. Specs (descriptions) still generic on many — owner rule wants real specs too; revisit.
